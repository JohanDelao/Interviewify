...
export default function Nav(){
    ...
    return (
        <div className="w-full shadow md:h-20 md:px-5 px-2">
            <div className='lg:max-w-screen-xl h-full lg:mx-auto flex items-center justify-between'>
                <div className='flex items-center'>
                    ...
                    <Link href={'/'} className='font-bold text-2xl lg:text-3xl'>Interviewify</Link>
                </div>
                <div className='items-center md:w-5/12 lg:w-4/12 xl:w-3/12 justify-around hidden md:flex'>
                    ...
                    <Link className='bg-[#3772FF] text-white h-11 w-48 flex items-center justify-center rounded-md' href={"/auth/signup"}>
